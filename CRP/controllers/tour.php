...
<div class="container">
    ...
    <a style="float:right" href="#tour_modal" data-toggle="modal" id='add' data-id="1"><i class="fa fa-plus fa-2x"
...
$sql = "SELECT t.ninternal_id,t.ntour_id,t.ddate,t.norg_id,t.nperson_to_meet_id,t.npurpose_id,t.tbriefTalk,
t.dnext_date,t.isAvailable,
...
if (isset($_POST['search'])){
    ...
    if(isset($_POST['nextDateCheckbox'])){
        $sql=DateFilter::prepareQuery('t.dnext_date',$sql);

    }else{
        $sql=DateFilter::prepareQuery('t.ddate',$sql);
    }
}
...
echo "<table id='tourTable'  name='tourTable' >
...
while ($row = mysqli_fetch_array($retval, MYSQLI_ASSOC)) {
    ...
    echo "<td style='display:none;'>" . $row['ntour_id'] . "</td>";

    echo "<td ><a  href='#tour_modal' data-toggle='modal' class='updateClass' data-id='2'><i class='fa fa-edit fa-2x'></i></a></td>";
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#tourTable tbody').on('click', '.updateClass', function () {
            var saveOrUpdate = $(this).data('id');
            ...
            $.ajax({
                ...
                success: function (row_datas) {
                    $.each(JSON.parse(row_datas), function (idx, row_data) {
                        ...
                        $(".modal-body #tourId").val(row_data.ntour_id);
        ...
        $('#tourTable').on('click', '.action-delete', function () {
        ...
        {
            $(this).find('tourForm').trigger('reset');
        }) ;
...
<form id="tourForm" method="post" action="../utils/saveTourData.php" >

    <div class="modal fade" id="tour_modal" tabindex="-1" role="dialog" aria-labelledby="my_modalLabel">
        <div class="modal-dialog" role="dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Tour Information</h4>
                </div>
                <div class="modal-body">
                    <table>
                        ...
                        <tr>
                            <td>Tour Code</td>
                            <td>
                                <input type="text" name="tourId" id="tourId" class="form-control"
                                       maxlength="50" required/>
                            </td>
                        </tr>
                        <tr>
