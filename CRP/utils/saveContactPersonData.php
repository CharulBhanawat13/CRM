...
if (isset($_POST['id_toDelete'])) {
    ...
    $sql = "UPDATE tbl_contactperson SET isAvailable =0 ,dupdated_date=now() WHERE ninternal_id = $internal_id";
...
if (isset($_POST['submitData'])) {
    ...
    if ($saveOrUpdate == 2) {
        ...
        CloseCon($conn);
        echo "<script>window.location.href='../controllers/contactPerson.php';</script>";
        exit;
    }
