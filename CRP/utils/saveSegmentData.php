...
if (isset($_POST['id_toDelete'])) {
    ...
    $sql = "UPDATE tbl_segment SET isAvailable =0,dupdated_date=now() WHERE ninternal_id = $internal_id";
...
if (isset($_POST['submitData'])) {
    ...
    if ($saveOrUpdate == 2) {
        ...
        CloseCon($conn);
        echo "<script>window.location.href='../controllers/segment.php';</script>";
        exit;
       // header("Location: ../controllers/segment.php");
    }
