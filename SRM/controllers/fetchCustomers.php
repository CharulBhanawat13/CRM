...
if (isset($_POST['fetchCustomers'])) {
    ...
    $conn = OpenMSSQLCon();
    $sql = "select ac.cACName,ad.cAddress,ad.cGSTNo,ad.cPanNo,details.cPersonName,ad.cContactNo,ad.cEmailID from tbl_AccountMaster ac 
    ...
    try {
        while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
            ...
            WHERE cGSTNo=$cGSTNo";
                ...
                $internal_id=ServiceLayer::getMaximumID('tbl_customer','ninternal_id');
